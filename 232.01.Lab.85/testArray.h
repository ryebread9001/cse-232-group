...
public:
   ...
   {  // setup
      ...
      setupStandardFixture(a);
      // exercise
      custom::array::iterator it(&(a.__elems_[2]));
      // verify
   ...
   {  // setup
      ...
      custom::array a;
      setupStandardFixture(a);
      custom::array::iterator itRHS;
      itRHS.p = &(a.__elems_[2]);    
      // exercise
      custom::array::iterator itLHS(itRHS);
      // verify
  ...
  // Assign an iterator
    ...
    *    +----+----+----+----+
    *************************************************************/
   void setupStandardFixture(custom::array & a)
   {
      a.__elems_[0] = 26;
      a.__elems_[1] = 49;
      a.__elems_[2] = 67;
    ...
    *    +----+----+----+----+
    *************************************************************/
   void assertStandardFixtureParameters(const custom::array & a, int line, const char * function)
   {
