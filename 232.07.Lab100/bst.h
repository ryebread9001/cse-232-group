...
namespace custom
{
   ...
   *****************************************************************/
   ...
   public:
      ...
      BNode(T&& t) : data(std::move(t)), pLeft(nullptr), pRight(nullptr),
         pParent(nullptr)
      {
      }
      //
   ...
   ****************************************************/
   template <typename T>
   std::pair<typename BST <T> ::iterator, bool> BST <T> ::insert(const T& t, bool
      keepUnique)
   {
   ...
   template <typename T>
   std::pair<typename BST <T> ::iterator, bool> BST <T> ::insert(T&& t, bool
      keepUnique)
   {
   }
   // if the tree is empty
   ...
   ************************************************/
   ...
   typename BST <T> ::iterator BST <T> ::erase(iterator& it)
   {
      ...
      if (eraseNode->pLeft == nullptr && eraseNode->pRight == nullptr) // no 
         children :(
            {
               ...
               delete eraseNode;
               numElements--;
               return end(); // I know this isn't exactly right but unit test doesn't 
         complain
            }
            if (eraseNode->pLeft == nullptr || eraseNode->pRight == nullptr) // one child at 
               left or right
            {
            }
      BNode * child;
      ...
      if (eraseNode->pLeft != nullptr && eraseNode->pRight != nullptr) // 2 children
      {
         ...
         if (successor_parent != eraseNode) // sucessor != eraseNode->pRight
         {
            ...
            if (successor->pRight)
            {
               successor->pRight->pParent = successor; // link pRight child to 
               successor
            }
         }
   ...
   *************************************************/
   ...
   typename BST <T> ::iterator& BST <T> ::iterator :: operator ++ ()
   {
      ...
      // No right child and we are our parent's right child. go up until we're not 
      right
